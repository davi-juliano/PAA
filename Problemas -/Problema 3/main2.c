...
int percorre_matriz(int **matriz, int x, int y, int **movimento, int n){
    int *caminhos = (int*) calloc(8,sizeof(int));
    int i=0, x1=0, y1=0;
    matriz[x][y] = 2;
...
int main(){
    ...
    int **movimentos = (int**)calloc(8,sizeof(int));
    ...
    for(i=0; i<8; i++){
        movimentos[i] = (int*) calloc(2,sizeof(int));
    }
